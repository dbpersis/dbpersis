...
public class MyDataSource implements DataSource {
	...
	public List<Map<String, Object>> jdbcQuery(String sql) throws Exception {
	...
	public <T> T querySingle(String sql, BeanHandler<T> beanListHandler) throws Exception {
		List<T> result = query(sql, beanListHandler);
		if (result.size() > 0) {
			return result.get(0);
		} else {
			return null;
